...
// #d efine SPI_HW_SCK_PIN  (13) //PB1

#define SPI_SW_SS_PIN   (10) //PB2 //SS Atmega328PB
#define SPI_SW_MOSI_PIN (11) //PB3 //MOSI Atmega328PB
#define SPI_SW_MISO_PIN (12) //PB4 //MISO Atmega328PB
#define SPI_SW_SCK_PIN  (13) //PB5 //SCK Atmega328PB
